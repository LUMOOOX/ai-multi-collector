...
⚡ Мульти-платформенность:** Полная поддержка **DeepSeek**, **Gemini** и **ChatGPT** (включая `chatgpt.com`). [cite: 9, 10, 11]

🖱️ Выделение в один клик:** Используйте визуальный режим выбора сообщения или горячие клавиши. [cite: 95, 106]

🧹 Умная очистка:** Автоматически удаляет "мусорные" заголовки языков программирования (javascript, python и т.д.) при копировании из ChatGPT. [cite: 65, 68]

📊 Статус-панель:** Отображает количество скопированных блоков и общее число символов. [cite: 90]

💾 Память выделения:** Скрипт запоминает последнее выбранное сообщение даже после перезагрузки страницы. [cite: 112, 113]
